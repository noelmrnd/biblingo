<template>
  ...
  >
    <template #icon>
      <div class="w-11 h-11 rounded-2xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center shrink-0">
        <HelpCircle class="w-5 h-5 text-purple-400 stroke-[2.5]" />
      </div>
    </template>
