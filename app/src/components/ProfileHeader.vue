<template>
  <div class="relative text-center pt-4 pb-6 px-4 -mx-4 -mt-4 space-y-3 overflow-hidden bg-[radial-gradient(ellipse_at_top,_rgba(28,176,246,0.18),_transparent_62%)]">
    <slot name="corner" />
