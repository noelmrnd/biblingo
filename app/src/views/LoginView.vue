    ...
    <div class="max-w-md w-full flex flex-col items-center z-10 space-y-8">
      ...
      <div class="w-full space-y-3.5 pt-4">
        ...
        <button 
          ...
          @click="loginApple"
          :disabled="loading"
          class="w-full bg-white text-black font-extrabold py-4 px-6 rounded-2xl transition-all duration-150 shadow-md active:shadow-sm active:scale-[0.97] active:brightness-95 flex items-center justify-center gap-3 text-base cursor-pointer disabled:opacity-50"
        >
